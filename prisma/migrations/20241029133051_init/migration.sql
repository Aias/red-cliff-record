...
-- AddForeignKey
ALTER TABLE "ExtractRelation" ADD CONSTRAINT "ExtractRelation_fromId_fkey" FOREIGN KEY ("fromId") REFERENCES "Extract"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ExtractRelation" ADD CONSTRAINT "ExtractRelation_toId_fkey" FOREIGN KEY ("toId") REFERENCES "Extract"("id") ON DELETE CASCADE ON UPDATE CASCADE;
