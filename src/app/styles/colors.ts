...
export const semanticColors = defineSemanticTokens.colors({
  ...
  display: { value: 'var(--rcr-colors-color-palette-display)' },
  primary: { value: 'var(--rcr-colors-color-palette-primary)' },
  secondary: { value: 'var(--rcr-colors-color-palette-secondary)' },
  muted: { value: 'var(--rcr-colors-color-palette-muted)' },
  symbol: { value: 'var(--rcr-colors-color-palette-symbol)' },
  accent: { value: 'var(--rcr-colors-color-palette-accent)' },
  accentActive: { value: 'var(--rcr-colors-color-palette-accent-active)' },
  background: { value: 'var(--rcr-colors-color-palette-background)' },
  surface: { value: 'var(--rcr-colors-color-palette-surface)' },
  container: { value: 'var(--rcr-colors-color-palette-container)' },
  float: { value: 'var(--rcr-colors-color-palette-float)' },
  divider: { value: 'var(--rcr-colors-color-palette-divider)' },
  border: { value: 'var(--rcr-colors-color-palette-border)' },
  edge: { value: 'var(--rcr-colors-color-palette-edge)' },
  focus: { value: 'var(--rcr-colors-color-palette-focus)' },
  mist: { value: 'var(--rcr-colors-color-palette-mist)' },
  splash: { value: 'var(--rcr-colors-color-palette-splash)' },
  flood: { value: 'var(--rcr-colors-color-palette-flood)' },
  main: { value: 'var(--rcr-colors-color-palette-main)' },
  mainActive: { value: 'var(--rcr-colors-color-palette-main-active)' },
  mainContrast: { value: 'var(--rcr-colors-color-palette-main-contrast)' },
});
