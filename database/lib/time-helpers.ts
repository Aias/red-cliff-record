...
export const chromeEpochMicrosecondsToDatetime = (chromeEpochMicroseconds: number | bigint): Date => {
	return new Date((Number(chromeEpochMicroseconds) / 1000000 - CHROME_EPOCH_TO_UNIX_SECONDS) * 1000);
};
